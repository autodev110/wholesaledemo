...
export default function Home() {
  return (
    <main className="bg-gray-50 text-[#001429]">
      {/* HERO SECTION - Now only contains the logo image */}
      <div className="flex flex-col items-center justify-center text-center bg-gradient-to-b from-[#001429] to-[#002952] py-0">        
        <Image
      ...
      <div className="py-24 flex flex-col items-center justify-center text-center bg-white">
        {/* This is now the official, single H1 tag for the page. This is perfect for SEO. */}
